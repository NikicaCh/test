module.exports = ({ body }) => {
    let statement1 = "Кај именуваниот НЕ ПОСТОИ патолошка состојба."
    let statement2 = "Работникот Е СПОСОБЕН за занимањето кое го обавува."
    if(body.radio1 == 1 && body.radio2 == 1){
        statement1 = "Кај именуваниот ПОСТОИ патолошка состојба."
        statement2 = "Работникот Е СПОСОБЕН за занимањето кое го обавува."
    } else if(body.radio1 == 1 && body.radio2 == 2) {
        statement1 = "Кај именуваниот ПОСТОИ патолошка состојба која  НЕ ПРЕТСТАВУВА контраиндикација за работа, односно работни задачи."
        statement2 = "Работникот Е СПОСОБЕН за занимањето кое го обавува."
    } else if(body.radio1 == 2 && body.radio2 == 2) {
        statement1 = "Кај именуваниот ПОСТОИ патолошка состојба која ПРЕТСТАВУВА контраиндикација за работа, односно работни задачи."
        statement2 = "Работникот Е СПОСОБЕН СО ОГРАНИЧУВАЊЕ за занимањето кое го обавува."
    } else if(body.radio1 == 3 && body.radio2 == 2) {
        statement1 = "Кај именуваниот ПОСТОИ патолошка состојба."
        statement2 = "Работникот НЕ Е СПОСОБЕН за занимањето кое го обавува."
    }
